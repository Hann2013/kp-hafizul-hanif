...
Public Class Form2
    ...
    Private Sub PD_PrintPage(sender As Object, e As PrintPageEventArgs) Handles PD.PrintPage
        ...
        e.Graphics.DrawString("Bakso Malang", f14, Brushes.Black, centermargin, 5, tengah)
        e.Graphics.DrawString("JL.Manggis Blok d7 no 26, Cibitung, Bekasi," & vbNewLine & " Kab Bekasi, Jawa Barat, 17510", f10, Brushes.Black, centermargin, 30, tengah)
        e.Graphics.DrawString("Hp: 0856-9710-8464", f10, Brushes.Black, centermargin, 65, tengah)

        e.Graphics.DrawString("Nama Kasir :", f10, Brushes.Black, 0, 90)
        e.Graphics.DrawString("Pijul", f10, Brushes.Black, 75, 90)
